...
/**
 * examples.dao.tiger.EmployeeAutoDao の自動生成 JUnit3 テスト。
 * s2dao-testgen フェーズ2 が生成。Java5 互換構文のみ。
 */
public class EmployeeAutoDaoTest extends TestCase {

    private S2TestContext ctx;
    private examples.dao.tiger.EmployeeAutoDao dao;

    protected void setUp() throws Exception {
        super.setUp();
        ctx = new S2TestContext();
        dao = (examples.dao.tiger.EmployeeAutoDao) ctx.getComponent(examples.dao.tiger.EmployeeAutoDao.class);
    ...
    // TODO: テスト未生成(スキップ) fetchEmployeesBySearchCondition : 未対応の引数型: FetchHandler<Employee>
}
